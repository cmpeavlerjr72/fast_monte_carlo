...
# ---------- Load ----------
df = pd.read_csv("ml_pass_yards_2022_2024.csv")
...
if 'target_name' in df.columns:  cat_features.append('target_name')  # OK if many Unknowns
...
# Target: clip to tame outliers; passes can have bigger tails than rushes
y = df['yardsGained'].clip(-20, 80)
...
for q, m in models.items():
    joblib.dump(m, f"pass_yards_q{int(q*100)}.joblib")
print("Saved pass_yards_q10/50/90.joblib")
